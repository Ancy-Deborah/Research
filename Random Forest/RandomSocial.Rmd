...
data1_set_size= floor(nrow(student)*0.70)
...
rf<-randomForest(class~activities+higher+internet+nursery+paid+romantic+absences+health+freetime+goout+Dalc+Walc, data=training, mtry=10, ntree=300, importance=TRUE)
rf
plot(rf)
