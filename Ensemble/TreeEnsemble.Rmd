...
<h3>DECISION TREE C5.0</h3>

```{r}
model_gb<- train(trainSet[,predictors],trainSet[,response], method="C5.0",trControl=fitControl,tuneLength=3)
...
<h3>DECISION TREE -RPART</h3>
```{r}
model_rf<-train(trainSet[,predictors],trainSet[,response],method="rpart",trControl=fitControl,tuneLength=3)
...
model_lr<-train(trainSet[,predictors],trainSet[,response],method='rf',ntree=450,trControl=fitControl,tuneLength=3)
